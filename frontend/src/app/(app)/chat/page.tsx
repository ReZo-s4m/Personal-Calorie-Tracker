...
export default function ChatPage() {
    ...
    return (
      <div className="flex flex-col gap-4">
        <header className="page-masthead">
          <p className="kicker">Ask AI</p>
          <h1 className="mt-1 text-[1.65rem] font-medium tracking-tight sm:text-3xl">Ask AI</h1>
        </header>
        <EmptyState
          title="Ask AI is switched off"
          ...
          action={
            <Link href="/log">
              <Button variant="secondary">Add a meal instead</Button>
            </Link>
          }
        />
      </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      <header className="page-masthead flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="kicker">Ask AI</p>
          <h1 className="mt-1 text-[1.65rem] font-medium tracking-tight sm:text-3xl">Ask AI</h1>
      ...
      <section className="flex min-h-[min(68vh,calc(100dvh-14rem))] flex-col overflow-hidden rounded-md border border-border bg-surface">
        ...
        <div className="flex flex-1 flex-col justify-between gap-4 p-4 sm:gap-5 sm:p-5">
          {turns.length === 0 ? (
            <div className="flex flex-1 flex-col justify-center gap-6">
              <div className="rounded-md border border-border bg-surface-raised px-5 py-6 sm:px-6 sm:py-7">
                <p className="kicker">Ask it</p>
              ...
              <div className="flex flex-wrap gap-2">
                {SUGGESTIONS.map((suggestion) => (
                  <button
                    ...
                    className="rounded-sm border border-border-strong px-3.5 py-1.5 text-left text-xs text-muted transition-colors hover:border-foreground hover:text-foreground"
                  >
                    {suggestion}
                  </button>
                ))}
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-subtle">
              ...
              first; you confirm before it is logged. Check anything that matters on Overview or
              Food Log.
            </p>
          </div>
        </div>
