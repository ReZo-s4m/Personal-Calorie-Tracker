...
export default function EntriesPage() {
  ...
  function requestDelete(entry: FoodEntry) {
    ...
    <div className="flex flex-col gap-5">
      <header className="page-masthead flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h1 className="mt-1 text-[1.65rem] font-medium tracking-tight sm:text-3xl">Entries</h1>
      ...
      {pendingDelete && (
        <ConfirmDialog
          ...
          description={`“${pendingDelete.foodName}” will be removed from your food log. This cannot be undone.`}
...
function SummaryTile({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-border bg-surface p-4 shadow-[0_1px_2px_rgb(17_17_19/0.04)]">
