...
export function EntryFormModal({
  ...
  return (
    ...
    >
      <div
        className={cx(
          'w-full rounded-t-3xl border border-border bg-surface p-5 shadow-[0_16px_48px_rgb(17_17_19/0.14)] sm:my-8 sm:rounded-xl sm:p-6',
          entry ? 'max-w-lg' : 'max-w-5xl',
        )}
      >
        <header className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold">{entry ? 'Edit meal' : 'Add meal'}</h2>
