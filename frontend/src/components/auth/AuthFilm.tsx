...
const COPY = {
  login: {
    ...
    facts: ['Overview', 'Target', 'Insights'],
  },
  signup: {
    kicker: 'A diary, not a diet',
    title: 'Log meals. Stay on goal.',
    body: 'Add a meal, a photo or a sentence. One record. Insights that help you hit the day.',
    facts: ['Manual', 'Scan', 'Upload a PDF'],
  },
} as const;
