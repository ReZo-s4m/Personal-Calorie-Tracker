    ...
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute z-40 mt-1 w-[min(17.5rem,calc(100vw-2rem))] rounded-md border border-border bg-surface p-3 shadow-[0_12px_32px_rgb(28_20_16/0.12)]"
        >
