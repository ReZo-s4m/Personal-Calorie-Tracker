...
export const createWeightRules = [
  body('kg')
...
export const listWeightsRules = paginationRules;

export const weightIdRules = [param('id').trim().notEmpty().withMessage('Weight id is required.')];
