...
import type { IChatProvider } from '../../../providers/ai/index.js';
...
import { AttachmentsLogic } from './AttachmentsLogic.js';
import {
  editImportRows,
  formatExtraction,
  formatImportTable,
...
/** None of these cases reach a collaborator, so the stubs stay empty. */
const attachments = new AttachmentsLogic(
  {} as IExtractLogic,
  {} as IImportsLogic,
  {} as IEntriesLogic,
  {} as IChatProvider,
);
const applyAttachPending = attachments.applyAttachPending.bind(attachments);
