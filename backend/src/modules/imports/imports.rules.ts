...
import { MAX_IMPORT_ROWS } from '../../providers/diary/diary-text.parser.js';

const DATE_KEY = /^\d{4}-\d{2}-\d{2}$/;

export const importTodayRules = [
  body('today')
    .matches(DATE_KEY)
...
export const importCommitRules = [
  ...importTodayRules,
  body('rows')
