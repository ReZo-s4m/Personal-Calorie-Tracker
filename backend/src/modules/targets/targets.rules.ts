...
export const createTargetRules = [
  body('dailyCalories')
...
export const listTargetsRules = paginationRules;

export const currentTargetRules = [
  query('date')
    .optional()
    .matches(/^\d{4}-\d{2}-\d{2}$/)
...
export const targetIdRules = [param('id').trim().notEmpty().withMessage('Goal id is required.')];
